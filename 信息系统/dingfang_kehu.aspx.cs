...
public partial class dingfang_kehu : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string strInsert = "INSERT INTO customer_table ( [user_name],[user_id],[telephone],[room_type],[room_number],[room_price],[time],[duringtime]) VALUES ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + DropDownList1.Text + "','" + Label2.Text + "','" + Label3.Text + "','" + strtime + "','" + TextBox5.Text + "')";
