<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dingfang_kehu.aspx.cs" Inherits="dingfang_kehu" %>
...
<div id="content" 
 ...
 <br />
    ...
    <asp:DropDownList ID="DropDownList1" runat="server" Height="29px" Width="128px" 
            style="font-size: large; font-family: 华文楷体">
    ...
    <asp:Label ID="time" runat="server" Text="入住时间" CssClass="style1" 
        ...
        <br /> <br />
    <asp:Label ID="stime" runat="server" Text="入住天数" CssClass="style1" 
            style="color: black; font-family: 华文楷体;"></asp:Label>
    <asp:TextBox ID="TextBox5" runat="server" Height="20px"></asp:TextBox><br /> <br />


    <asp:Button ID="Button1" runat="server" Text="确定" Width="74px" 
            onclick="Button1_Click" Height="36px" />&nbsp&nbsp
